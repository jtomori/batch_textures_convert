...
class MainGui(QtWidgets.QWidget):
    ...
    def finishedConversion(self):
        ...
        """
        self.progress_text.setText(self.progress_bar.text(
        ) + " in {0:.3f} seconds".format(time.time() - self.start_conversion_time))
        self.button_stop.setEnabled(False)
    ...
    def convert(self):
        ...
        batch_convert.batchConvert(ui_obj=self, input_formats=input_formats,
                                   output_format_func=output_format_func, root_path=root_path, threads=threads)
